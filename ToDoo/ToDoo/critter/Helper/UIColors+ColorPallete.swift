...
extension UIColor {
    static let light = #colorLiteral(red: 0.768627451, green: 1, blue: 0.9764705882, alpha: 1)  //C4FFF9
    static let dark = #colorLiteral(red: 0.3450980392, green: 0.7882352941, blue: 0.7254901961, alpha: 1)   //58C9B9
